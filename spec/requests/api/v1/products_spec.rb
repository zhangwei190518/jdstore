...
RSpec.describe "Products", type: :request do
  ...
  describe "GET /api/v1/products" do
    context "right count" do
      ...
      it "without params" do
        get "/api/v1/products", params: { token: access_token[:token] }
      ...
      context "with category_name params" do
        ...
        it "when category is iPhone" do
          get "/api/v1/products", params: { category_name: "iPhone", token: access_token[:token] }
        ...
        it "when category is Mac" do
          get "/api/v1/products", params: { category_name: "Mac", token: access_token[:token] }
    ...
    it "paged" do
      ...
      get "/api/v1/products", params: { page: 3, per_page: 2, token: access_token[:token] }
  ...
  describe "GET /api/v1/products/:id" do
    it "with right data structure" do
      ...
      get "/api/v1/products/#{product.id}", params: { token: access_token[:token] }
  ...
  describe "GET /api/v1/products/search" do
    it "without q params" do
      get "/api/v1/products/search", params: { token: access_token[:token] }
    ...
    it "with matched result" do
      ...
      get "/api/v1/products/search", params: { q: "Ma", token: access_token[:token] }
    ...
    it "without matched result" do
      create_list(:public_product, 2)
      get "/api/v1/products/search", params: { q: "non_exists_product_title", token: access_token[:token] }
    ...
    it "paged" do
      ...
      get "/api/v1/products/search", params: { q: "phone", page: 2, per_page: 2, token: access_token[:token] }
